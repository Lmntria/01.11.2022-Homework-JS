...
function combineArrays(firstArr,...restOfArr) {
  let newArr=restOfArr.flatMap((num)=>num)
  let combineArr=newArr.concat(firstArr).sort((x,y)=>x-y)
  return combineArr
}

console.log(combineArrays(firstArr,secondArr,thirdArr,forthArr,fifthArr))